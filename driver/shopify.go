...
func OpenDatabaseForShopify(c *ConnectionInfo) *gorm.DB {
	var db *gorm.DB
	...
	db = conn
	db.Debug().AutoMigrate(&models.Shop{}, &models.Product{}, &models.ProductVariant{})
	logger.Logger.Info("CONNECT TO SHOPIFY DATABASE SUCCESSFULLY!")
